...
public class SC_Register extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sc__register);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (result)
                {
                    Toast.makeText(SC_Register.this, "data inserted", Toast.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(SC_Register.this, "data not inserted ", Toast.LENGTH_SHORT).show();
        ...
        delete.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View view) {
                Intent intentDelete = new Intent(SC_Register.this,Deleted.class);
        ...
        update.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intentUpdate = new Intent(SC_Register.this,Updatedata.class);
